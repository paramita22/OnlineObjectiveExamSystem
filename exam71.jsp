...
<html>
    <head>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
          <title>Exam7>>Subject:: Computer # Exam Online</title>
          <style>
              #clock{
                  height:10vh ;
                  width:20% ;
    ...
    <body>
        ...
        <div class="container-fluid">
            <p id="banner-text">Exam Subject : Computer<br/>
        ...
        <div class="row text-center">
            <div class="col-xs-5">
                <div class="panel panel-primary">
                    <div class="panel-header"><p class="question-text">Q. 1) Java is: </p></div><br/>
                    <div class="panel-body">
                    Answers:
                 <form method="POST" action="rectifiedExam1.jsp">
                    <input type="checkbox"/>   A. Object Oriented Language<br/>
                    <input type="checkbox"/>   B. Platform independent Language<br/>
                    <input type="checkbox"/>   C. Involves Inheritance<br/>
             ...
             <div class="col-xs-6">
                <div class="panel panel-primary">
                    <div class="panel-header"><p class="question-text">Q. 2) The ODBC bridge is written in:</p></div><br/>
                    <div class="panel-body">
                    Answers:
                 <form method="POST" action="rectifiedExam1.jsp">
                    <input type="checkbox"/>   A. Java<br/>
                    <input type="checkbox"/>   B. .Net<br/>
            ...
            <a href="exam72.jsp"><input type="submit" value="Save and Next" class="btn btn-primary"/></a></div>
