...
<html>
    <head>
        ...
        <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
          <title>Exam4>>Subject:: Chemistry # Exam Online</title>
          <style>
              #clock{
                  height:10vh ;
                  width:20% ;
    ...
    <body>
        ...
        <div class="container-fluid">
            <p id="banner-text">Exam Subject : Chemistry<br/>
        ...
        <div class="row text-center">
            <div class="col-xs-5">
                <div class="panel panel-primary">
                    <div class="panel-header"><p class="question-text">Q. 1) Rydberg's Constant for Hydrogen is: </p></div><br/>
                    <div class="panel-body">
                    Answers:
                 <form method="POST" action="rectifiedExam1.jsp">
                    <input type="checkbox"/>   A. 109,677 cm<br/>
                    <input type="checkbox"/>   B.  109,677/cm<br/>
                    <input type="checkbox"/>   C.  119,777/cm<br/>
             ...
             <div class="col-xs-6">
                <div class="panel panel-primary">
                    <div class="panel-header"><p class="question-text">Q. 2) According to De Broglie wavelength of a particle varies:</p></div><br/>
                    <div class="panel-body">
                    Answers:
                 <form method="POST" action="rectifiedExam1.jsp">
                    <input type="checkbox"/>   A. Directly with momentum<br/>
                    <input type="checkbox"/>   B. Directly with mass<br/>
                    <input type="checkbox"/>   C. Inversely with momentum<br/>
                    <input type="checkbox"/>   D. Does not depend on momentum<br/>
                    <br/>
